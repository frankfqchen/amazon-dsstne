...
public class DenseNNDataSet extends NNDataSet {
  ...
  public long[] getSparseStart() {
    throw new UnsupportedOperationException("dense datasets do not have sparse start indexes");
  }

  @Override
  public long[] getSparseEnd() {
    throw new UnsupportedOperationException("dense datasets do not have sparse end indexes");
  }

  @Override
  public long[] getSparseIndex() {
    throw new UnsupportedOperationException("dense datasets do not have sparse indexes");
  }

  @Override
  public float[] getWeights() {
    throw new UnsupportedOperationException("dense datasets do not have weights");
  }
